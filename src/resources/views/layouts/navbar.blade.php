                ...
                @auth
                    ...
                    <div class="ml-3 relative z-50">
                        ...
                        <div class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 z-50 transition-all">
                            ...
                            <a href="{{ route('profile.show') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-orange-600 transition-colors">Profil</a>
        ...
        <div class="pt-4 pb-4 border-t border-gray-200">
            @auth
                ...
                <div class="px-4 space-y-2 mt-3">
                    ...
                    <a href="{{ route('profile.show') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                        Profil
                    </a>
