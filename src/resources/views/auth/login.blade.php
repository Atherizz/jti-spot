        ...
        <div class="w-full md:w-[55%] bg-white p-10 md:p-14 flex flex-col justify-center relative">
            <div class="max-w-[380px] w-full mx-auto">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-sm font-medium text-gray-500">Gunakan Kata Sandi pada SIAKAD untuk Masuk</p>
                </div>
                ...
                <form method="POST" action="{{ url('/login') }}" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-2">Identifikasi (NIM/NIP)</label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password-input" type="password" name="password" required placeholder="••••••••"
                                class="pl-11 pr-11 block w-full bg-white border border-gray-200 text-ink text-sm font-medium tracking-widest rounded-xl py-3.5 focus:ring-2 focus:ring-orange-100 focus:border-orange-400 transition-all shadow-sm placeholder:tracking-normal placeholder:text-gray-400">
