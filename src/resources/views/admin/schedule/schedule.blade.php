    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 stagger-2">
        ...
        <div class="editorial-panel bg-white p-6 relative group transform hover:-translate-y-1 transition-transform">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-gray-100 text-gray-500 tracking-widest uppercase">Fasilitas Dialokasikan</span>
            </div>
        ...
        <div class="editorial-panel bg-white p-6 relative group transform hover:-translate-y-1 transition-transform">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-gray-100 text-gray-500 tracking-widest uppercase">Konstituen Aktif</span>
            </div>
